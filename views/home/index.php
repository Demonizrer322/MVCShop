    ...
    <div class="hero-section section position-relative">
            <div class="hero-slider section">
                ...
                <!--Hero Item start-->
                <div class="hero-item  bg-image" data-bg="http://<?=$_SERVER['HTTP_HOST']?>/assets/images/hero/hero-1.jpg">
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
                ...
                <!--Hero Item start-->
                <div class="hero-item bg-image" data-bg="http://<?=$_SERVER['HTTP_HOST']?>/assets/images/hero/hero-2.jpg">
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        ...
                        <div class="single-banner-item mb-30">
                            <div class="banner-image">
                                <a href="shop.php">
                                    <img src="http://<?=$_SERVER['HTTP_HOST']?>/assets/images/banner/banner1.jpg" alt="">
                                </a>
                            </div>
                        ...
                        <div class="single-banner-item mb-30">
                            <div class="banner-image">
                                <a href="shop-left-sidebar.php">
                                    <img src="http://<?=$_SERVER['HTTP_HOST']?>/assets/images/banner/banner2.jpg" alt="">
                                </a>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-4 col-sm-6">
                                ...
                                <div class="single-grid-product mb-40">
                                    <div class="product-image">
                                        <a href="single-product.php">
                                            <img src="http://<?=$_SERVER['HTTP_HOST']?>/assets/images/product/product-9.jpg" class="img-fluid" alt="">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6">
                                ...
                                <div class="single-grid-product mb-40">
                                    <div class="product-image">
                                        <a href="single-product.php">
                                            <img src="http://<?=$_SERVER['HTTP_HOST']?>/assets/images/product/product-14.jpg" class="img-fluid" alt="">
                                        </a>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="single-feature mb-30">
                            <div class="feature-image">
                                <img src="http://<?=$_SERVER['HTTP_HOST']?>/assets/images/icons/feature-1.png" class="img-fluid" alt="">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="single-feature mb-30">
                            <div class="feature-image">
                                <img src="http://<?=$_SERVER['HTTP_HOST']?>/assets/images/icons/feature-2.png" class="img-fluid" alt="">
                            </div>
                            <div class="feature-content">
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="single-feature mb-30">
                            <div class="feature-image">
                                <img src="http://<?=$_SERVER['HTTP_HOST']?>/assets/images/icons/feature-3.png" class="img-fluid" alt="">
                            </div>
                            <div class="feature-content">
                                        ...
                                        <div class="testimonial-slider-content">
                                                ...
                                                <div class="row align-items-center">
                                                    <div class="col-md-5">
                                                        <div class="testimonial-image">
                                                            <img src="http://<?=$_SERVER['HTTP_HOST']?>/assets/images/testimonial/testimonial-2.png" alt="">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-7">
                                            ...
                                            <div class="item">
                                                <div class="row align-items-center">
                                                    <div class="col-md-5">
                                                        <div class="testimonial-image">
                                                            <img src="http://<?=$_SERVER['HTTP_HOST']?>/assets/images/testimonial/testimonial-1.png" alt="">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-7">
                                                        <div class="testimonial testimonial-style-2 gutter-item">
                ...
                <div class="row">
                    <div class="brand-slider section">
                        <div class="col">
                            ...
                            <div class="single-brand">
                                <div class="brand-image">
                                    <img src="http://<?=$_SERVER['HTTP_HOST']?>/assets/images/brands/brand-1.png" alt="">
                                </div>
                            </div>
                            <!-- Single Brand End -->
                        </div>
                        <div class="col">
                            ...
                            <div class="single-brand">
                                <div class="brand-image">
                                    <img src="http://<?=$_SERVER['HTTP_HOST']?>/assets/images/brands/brand-2.png" alt="">
                                </div>
                            </div>
                            <!-- Single Brand End -->
                        </div>
                        <div class="col">
                            ...
                            <div class="single-brand">
                                <div class="brand-image">
                                    <img src="http://<?=$_SERVER['HTTP_HOST']?>/assets/images/brands/brand-3.png" alt="">
                                </div>
                            </div>
                            <!-- Single Brand End -->
                        </div>
                        <div class="col">
                            ...
                            <div class="single-brand">
                                <div class="brand-image">
                                    <img src="http://<?=$_SERVER['HTTP_HOST']?>/assets/images/brands/brand-4.png" alt="">
                                </div>
                            </div>
                            <!-- Single Brand End -->
                        </div>
                        <div class="col">
                            ...
                            <div class="single-brand">
                                <div class="brand-image">
                                    <img src="http://<?=$_SERVER['HTTP_HOST']?>/assets/images/brands/brand-5.png" alt="">
                                </div>
                            </div>
                            <!-- Single Brand End -->
                        </div>
