                            ...
                            <div class="row justify-content-between align-items-center">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="payment-getway text-lg-right text-center">
                                        <img src="http://<?=$_SERVER['HTTP_HOST']?>/assets/images/payment.png" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    ...
                                    <div class="product-details-left">
                                        <div class="product-details-images">
                                            <div class="lg-image">
                                                <img src="http://<?=$_SERVER['HTTP_HOST']?>/assets/images/product/large-product/l-product-1.jpg" alt="">
    ...
    <script src="http://<?=$_SERVER['HTTP_HOST']?>/assets/js/vendor/jquery-1.12.4.min.js"></script>
    <script src="https://maps.google.com/maps/api/js?sensor=false&libraries=geometry&v=3.22&key=AIzaSyDAq7MrCR1A2qIShmjbtLHSKjcEIEBEEwM"></script>
    <script src="http://<?=$_SERVER['HTTP_HOST']?>/assets/js/vendor/popper.min.js"></script>
    <script src="http://<?=$_SERVER['HTTP_HOST']?>/assets/js/vendor/bootstrap.min.js"></script>
