...
<head>
    ...
    <link rel="stylesheet" href="http://<?=$_SERVER['HTTP_HOST']?>/assets/css/vendor/bootstrap.min.css">
    <link rel="stylesheet" href="http://<?=$_SERVER['HTTP_HOST']?>/assets/css/vendor/iconfont.min.css">
    <link rel="stylesheet" href="http://<?=$_SERVER['HTTP_HOST']?>/assets/css/vendor/helper.css">
    <link rel="stylesheet" href="http://<?=$_SERVER['HTTP_HOST']?>/assets/css/plugins/plugins.css">
    <link rel="stylesheet" href="http://<?=$_SERVER['HTTP_HOST']?>/assets/css/style.css">
    <!-- Modernizr JS -->
    <script src="http://<?=$_SERVER['HTTP_HOST']?>/assets/js/vendor/modernizr-2.8.3.min.js"></script>
</head>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-xl-3 col-lg-2 col-md-4 col-12">
                            <!--Logo Area Start-->
                            <div class="logo-area">
                                <a href="http://localhost/home/index"><img src="http://<?=$_SERVER['HTTP_HOST']?>/assets/images/logo.png" alt=""></a>
                            </div>
                            <!--Logo Area End-->
                        </div>
                            ...
                            <div class="header-menu-area text-center">
                                <nav class="main-menu">
                                    <ul>
                                        ...
                                        <li><a href="http://<?=$_SERVER['HTTP_HOST']?>/user/contact">Contact</a></li>
                                    </ul>
                                </nav>
                            </div>
                                        ...
                                        <div class="header-cart">
                                            <ul class="cart-items">
                                                <li class="single-cart-item">
                                                    <div class="cart-img">
                                                        <a href="http://<?=$_SERVER['HTTP_HOST']?>/product/cart"><img src="http://<?=$_SERVER['HTTP_HOST']?>/assets/images/cart/cart1.jpg" alt=""></a>
                                                    </div>
                                                ...
                                                <li class="single-cart-item">
                                                    <div class="cart-img">
                                                        <a href="cart.php"><img src="http://<?=$_SERVER['HTTP_HOST']?>/assets/images/cart/cart2.jpg" alt=""></a>
                                                    </div>
                                                    <div class="cart-content">
                                                        <h5 class="product-name"><a href="http://<?=$_SERVER['HTTP_HOST']?>/product/singleProductTabstyle3">Lenovo Ideacentre 300</a></h5>
                                                        <span class="product-quantity">1 ×</span>
                                            ...
                                            <div class="cart-btn">
                                                <a href="http://<?=$_SERVER['HTTP_HOST']?>/product/cart">View Cart</a>
                                                <a href="http://<?=$_SERVER['HTTP_HOST']?>/user/checkout">checkout</a>
                                            </div>
                                        </div>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-6 col-md-6">
                                        <div class="header-logo">
                                            <a href="index.php">
                                                <img src="http://<?=$_SERVER['HTTP_HOST']?>/assets/images/logo.png" class="img-fluid" alt="">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-6 col-md-6">
                        ...
                        <nav class="offcanvas-navigation">
                            <ul>
                                ...
                                <li class="menu-item-has-children"><a href="#">LANGUAGE: EN-GB </a>
                                    <ul class="submenu2">
                                        <li><a href="javascript:void(0)"><img src="http://<?=$_SERVER['HTTP_HOST']?>/assets/images/icons/en-gb.png" alt=""> English</a></li>
                                        <li><a href="javascript:void(0)"><img src="http://<?=$_SERVER['HTTP_HOST']?>/assets/images/icons/de-de.png" alt=""> Germany</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </nav>
