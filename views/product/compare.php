                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="product-image-title">
                                                <a href="#" class="image"><img src="http://<?=$_SERVER['HTTP_HOST']?>/assets/images/product/product-1.jpg" alt="Compare Product"></a>
                                                <a href="#" class="category">Laptop</a>
                                                <a href="#" class="title">Zeon Zen 4 Pro</a>
                                            </td>
                                            <td class="product-image-title">
                                                <a href="#" class="image"><img src="http://<?=$_SERVER['HTTP_HOST']?>/assets/images/product/product-2.jpg" alt="Compare Product"></a>
                                                <a href="#" class="category">Doren</a>
                                                <a href="#" class="title">Aquet Doren D 420</a>
                                            </td>
                                            <td class="product-image-title">
                                                <a href="#" class="image"><img src="http://<?=$_SERVER['HTTP_HOST']?>/assets/images/product/product-4.jpg" alt="Compare Product"></a>
